...
const selectProjectsTaskCount = projectsApiSlice.endpoints.getProjectsTaskCount.select()
const selectProjectsData = createSelector(selectProjectsResult, pr => pr.data)
const selectProjectsTaskCountData = createSelector(selectProjectsTaskCount, pr => pr.data)
...
} = projectsAdapter.getSelectors(state => selectProjectsTaskCountData(state) ?? initialState)